    ...
    <section className="flex-col md:flex-row flex items-center md:justify-between mt-16 mb-16 md:mb-12">
      ...
      <h2 className="text-center md:text-left text-lg mt-5 md:pl-8">
        <div className="flex gap-4">
          <IcoGitHub link={"https://github.com/tannershimanek"} />
          <IcoLinkedIn link={"https://www.linkedin.com/in/tshimanek/"} />
          <IcoTwitterX link={"https://x.com/TannerDotDev"} />
          <IcoInstagram link={"https://www.instagram.com/tannerdotdev/"} />          
        </div>
      </h2>
    </section>
  );
...
export default async function Page() {
  ...
  return (
    <div className="container mx-auto px-5">
      ...
      <Newsletter className="mx-auto max-w-2xl -mb-20" showDrop />
